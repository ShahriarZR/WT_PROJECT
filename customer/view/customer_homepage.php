...
<body>
    ...
    <a href="customer_homepage.php" class="website-name">Thrillscape</a>
    <div class="button-container">
    <a href="travel_package.php"><button class="btn">Book a Trip</button></a>
    <a href="travel_accessory.php"><button class="btn">Shop Accessories</button></a>
    <a href="cart.php"><button class="btn">My Cart</button></a>
    <a href="mybuy.php"><button class="btn">My Items</button></a>
    <a href="customer_profile.php"><button class="btn">My Profile</button></a>
        ...
        <div class="package-container">
            ...
            foreach ($rows as $row) {
                if ($count < 8) { 
                    ...
                    echo '<img src="../resources/' . htmlspecialchars($row["image"]) . '" alt="' . htmlspecialchars($row["tour_package_name"]) . '">';
        ...
        <div class="accessory-container">
            ...
            foreach ($rows1 as $row) {
                if ($accessoryCount < 8) { 
                    ...
                    echo '<img src="../resources/' . htmlspecialchars($row["travel_accessory_image"]) . '" alt="' . htmlspecialchars($row["name"]) . '">';
